...
$sql = "SELECT temperature FROM datalogger where sensor = ".$_GET["sensor"]." ORDER BY date_time DESC LIMIT 1";
...
$sql = "SELECT humidity FROM datalogger where sensor = ".$_GET["sensor"]." ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
